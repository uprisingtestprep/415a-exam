/* 415A Exam Simulator — Application Logic */

const ACCESS_CODE  = "415A9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "415a_exam_state_v1";
const SIM_Q_COUNT  = 150;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"hygiene": "Hygiene", "sanitation_and_safety": "Sanitation and Safety", "common_occupational_skills": "Common Occupational Skills", "produce": "Produce", "stocks_broths_and_soups": "Stocks Broths and Soups", "sauces": "Sauces", "dairy_plant_based_alternatives_and_eggs": "Dairy Plant-Based Alternatives and Eggs", "pastas_noodles_and_stuffed_items": "Pastas Noodles and Stuffed Items", "grains_pulses_seeds_nuts_and_proteins": "Grains Pulses Seeds Nuts and Proteins", "meats_game_poultry_and_variety_meats": "Meats Game Poultry and Variety Meats", "fish_and_seafood": "Fish and Seafood", "salads_and_sandwiches": "Salads and Sandwiches", "specialty_preparation": "Specialty Preparation", "sweet_and_savoury_baked_goods": "Sweet and Savoury Baked Goods"};  // maps domain key -> human-readable label for display
